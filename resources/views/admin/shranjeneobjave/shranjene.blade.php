            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Shranjene objave') }}</h5>
                            <span>{{ __('Seznam vseh shranjenih objav') }}</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card table-card">
                    ...
                    <div class="card-body ">
                        ...
                        @if (count($shranjene_objave))
                        

                            <div class="table-responsive">

                                @foreach ($shranjene_objave as $key => $objava)
                                <?php $objava = $objava->objava?>
                                
                                <div class="objava-display-holder-card">
                                    <div class="objava-display-nav">
                                        <div class="objava-display-user">{{$objava->user->name}}</div>
                                        <div class="objava-display-povecava"><a href="{{ URL('admin/objave/' . $objava->id) }}" class="ajax_modal" data-type="modal-xl" data-klasa="fade" data-heading="" title="{{ __('Poglej') }}"><i class="ik ik-eye f-16 mr-15 text-dark"></i></a></div>
                        ...
                        @else
                            ...
                            <div class="font-medium mct-no-data">{{ __('Trenutno še ni shranjenih objav!') }}</div>
