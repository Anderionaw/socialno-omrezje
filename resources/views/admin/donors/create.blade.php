...
@section('content')
    ...
    <form class="forms-sample mct_modl_form mct-donors-create-form" method="POST" action="{{ route('admin.donors.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="postmail_id">
                                ...
                                @foreach ($postmails as $value)
                                    <option value="{{$value->id}}">{{ $value->zip }} {{ $value->name }}</option>
                                @endforeach
                            </select>
                        </div>
